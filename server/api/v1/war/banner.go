...
var bannerService = service.ServiceGroupApp.WarServiceGroup.BannerService
...
// @Param data body war.Banner true "创建Banner"
...
func (bannerApi *BannerApi) CreateBanner(c *gin.Context) {
	...
	if err := utils.Verify(banner, verify); err != nil {
		response.FailWithMessage(err.Error(), c)
		return
	}
...
// @accept application/json
// @Produce application/json
// @Param data body war.Banner true "删除Banner"
...
// @accept application/json
// @Produce application/json
// @Param data body war.Banner true "更新Banner"
...
// @accept application/json
// @Produce application/json
// @Param data query war.Banner true "用id查询Banner"
...
// @accept application/json
// @Produce application/json
// @Param data query warReq.BannerSearch true "分页获取Banner列表"
// @Success 200 {string} string "{"success":true,"data":{},"msg":"获取成功"}"
// @Router /banner/getBannerList [get]
func (bannerApi *BannerApi) GetBannerList(c *gin.Context) {
	var pageInfo warReq.BannerSearch
...
// 获取小程序banner
func (bannerApi *BannerApi) GetBannerListForMini(c *gin.Context) {
	if list, err := bannerService.GetBannerListForMini(); err != nil {
		global.GVA_LOG.Error("获取失败!", zap.Error(err))
		response.FailWithMessage("获取失败", c)
	} else {
